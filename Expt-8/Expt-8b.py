...
master = Tk()
master.title("Rafat Muskan => 211P009 Customer Segmentation using Machine Learning")

Label(master, text="Rafat Muskan => 211P009 Customer Segmentation using Machine Learning", bg="Yellow", fg="black").grid(row=0, columnspan=2)
